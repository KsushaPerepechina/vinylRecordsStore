        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ol type="1" class="discharged">
                    <li>Реализованы два способа хранения корзины: для гостей и для зарегистрированных пользователей. Оба способа используют экземпляры одного класса <code>com.vironit.vinylRecordsStore.entity.Cart</code>.
                        <ul>
