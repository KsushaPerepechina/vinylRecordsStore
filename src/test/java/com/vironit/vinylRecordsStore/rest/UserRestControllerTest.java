...
import com.vironit.vinylRecordsStore.data.MarketData;
import com.vironit.vinylRecordsStore.data.UserData;
import com.vironit.vinylRecordsStore.dto.ContactsDTO;
import com.vironit.vinylRecordsStore.util.TestUtil;
...
public class UserRestControllerTest {
    ...
    public void Step6_getOrder_NotFound() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/rest/customer/orders/{id}", MarketData.IMPROBABLE_ID)
                .header("Authorization", UserData.BASIC_AUTH_VALUE)
                .accept(TestUtil.APPLICATION_JSON_UTF8)
        )
